<template>
  <div>
    <div class="container">
		<div class="title"><h1>Welcome to <br><span class="aboutUs"> PLANNER AHEAD</span><br> Meal Planner</h1></div>
		<h2>Our mission</h2>
		...
		<h2>What's special about Planner Ahead</h2>
...
body{
	...
	.container{
		...
		.title {
			background-image: url('../assets/healthy-food.jpg');
